...
➟ Zalo: 0896475332
➟ Github: https://github.com/Khang2ka6
═════════════════════════
""")
		...
		while True:
			try:
				sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"Dương Khang"+Color.LB+" --> "+Color.LG+"Home"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
				option = input()
...
def main():
	#  checking 
	VDH_Tool.styleText("🌚 Đợi Tí Đang Vào Tool...\n\n")
	pkgs = ['screen', 'node']
	install = True
	for pkg in pkgs:
		ur_mom = which(pkg)
